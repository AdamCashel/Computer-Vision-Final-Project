...
while (i < K)
   ...
   col_start = floor(template_columns / 2);
   col_end = col_start + image_columns - 1; %Changed from -1 was going out of bounds by 1
   %Get subwindow
...
%If after the last Strong Classifier configuration the window image is
%declared as a face picture  
result = 1;
return;
