function result = SearchForFace(image, boosted, weak_classifiers, face_size)
...
for weak_classifier = 1:classifier_number
    ...
    for vertical = 1:(vertical_size-face_vertical+1)
        for horizontal = 1:(horizontal_size-face_horizontal+1)
            horizontal+33
            vertical+33
            response = boosted_predict(image(horizontal:horizontal+12 , vertical:vertical+12), boosted, weak_classifiers, 50);
